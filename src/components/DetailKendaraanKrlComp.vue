...
<template>
    ...
    <div id="bus"  class="d-flex mx-auto rounded-pill my-10 " style="width: 250px; height: 50px; background-color: white;">
        ...
        <button  onclick="location.href='/DetailKendaraanKrl'" style="width: 125px; height: 50px; background-color:  #E8DEF8;" class="pa-3  border">
            <h4  class="text-black text-center ">Kereta</h4>
        </button>  
        <button id="train" onclick="location.href='/DetailKendaraanAngkot'" style="width: 125px; height: 50px; background-color: white;" class="rounded-te-pill pa-3 rounded-be-pill border">
